...
public class ClientFactorInfoDTO {
    ...
    @Builder
    public ClientFactorInfoDTO(Map<String, String> clientList,Map<String, String> smokeList, Map<String, String> typeList, Map<String, String> drinkList,  Map<String, String> jobList){
